package com.example.case_3.service;

import com.example.case_3.model.Staff;
...
public class StaffService {
    ...
    public Connection getConnection() {
        ...
        try {
            ...
            connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/qlcacem?useSSL=false", "root", "123456");
    ...
    public void saveStaff(Staff staff) {
        try {
            ...
            PreparedStatement preparedStatement = connection.prepareStatement("insert into employees(name, email, address, phone, salary, idDepartment) values (?, ?, ?, ?, ?, ?)");
    ...
    public void updateStaff(Staff staff) {
        try {
            Connection connection = getConnection();
            PreparedStatement preparedStatement = connection.prepareStatement("update employees set name = ?, email = ?, address = ?, phone = ?, salary = ?, idDepartment = ? where id = ?");
            preparedStatement.setString(1, staff.getName());
            preparedStatement.setString(2, staff.getMail());
            preparedStatement.setString(3, staff.getAddress());
            preparedStatement.setInt(4, staff.getPhone());
